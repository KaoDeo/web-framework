...
class ArrayWithOriginalIndices {
  ...
  constructor(array, equalsFn) {
    //  why i use array here simulating changes step-by-step? Without mutation, i’d need to:
    // 	Constantly recalculate the current state
    // 	Remap everything every time you do a move
    // 	Maintain a virtual copy of index shifts manually (very error-prone)
    this.#array = [...array];
